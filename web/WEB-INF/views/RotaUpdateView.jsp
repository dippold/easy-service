...
<html lang="pt-BR">
    ...
    <body>    
        ...
        <div id="main" class="container-fluid">
            ...
            <!-- FORM MAIN -->
            <form id="formUpdate" name="formUpdate" method="POST" action="mvc">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" id="nomeMenuInput" name="nomeMenuInput" max="20" required="required" placeholder="Nome no menu"
                               value="${entity.nomeMenu}">
                    </div>
                    <div class="form-group col-md-1">
                        <label for="mostrarNoMenuCombo">Mostrar?</label>                        
                        <!-- COMBOBOX MOSTRAR-NO-MENU -->
                        <SELECT id="mostrarNoMenuCombo" name="mostrarNoMenuCombo" size="1" class="form-control">
                            <c:if test="${entity.mostrarNoMenu == true}">
                                <option value="true" selected>Sim</option> 
                                <option value="false">Não</option>
                            </c:if> 
                            <c:if test="${entity.mostrarNoMenu == false}">
                    ...
                    <div class="form-group col-md-1">
                        ...
                        <SELECT id="sistemaCombo" name="sistemaCombo" size="1" class="form-control">
                            <c:if test="${entity.sistema == true}">
                                <option value="true" selected>Sim</option> 
                                <option value="false">Não</option>
                            </c:if> 
                            <c:if test="${entity.sistema == false}">
                                <option value="true">Sim</option> 
                                <option value="false" selected>Não</option>
                            </c:if>                             
                        </SELECT><!-- /COMBOBOX MOSTRAR-NO-MENU -->   
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <SELECT id="acaoCombo" name="acaoCombo" size="1" class="form-control">
                            <c:forEach var="action" items="${actions}">
                                <option value="${action.id}" ${entity.acao == action.id ? 'selected' : ''}>${action.name}</option>
                            </c:forEach>                                                            
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <SELECT id="acaoSucessoCombo" name="acaoSucessoCombo" size="1" class="form-control">
                            <c:forEach var="action" items="${actions}">
                                <option value="${action.id}" ${entity.acaoSucesso == action.id ? 'selected' : ''}>${action.name}</option>
                            </c:forEach>   
                        </SELECT><!-- COMBOBOX ACAO-NO-MODEL -->
                    </div>                    
                    <div class="form-group col-md-2">
                        ...
                        <SELECT id="acaoFalhaCombo" name="acaoFalhaCombo" size="1" class="form-control">
                            <c:forEach var="action" items="${actions}">
                                <option value="${action.id}" ${entity.acaoFalha == action.id ? 'selected' : ''}>${action.name}</option>
                            </c:forEach> 
                        </SELECT><!-- COMBOBOX ACAO-NO-MODEL -->
                    </div>                                                             
                </div><!-- /LINHA-4 -->                
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control" id="observacaoInput" name="observacaoInput" placeholder="Observações"
                                  rows="5" maxlength="250">${entity.observacao}</textarea>
