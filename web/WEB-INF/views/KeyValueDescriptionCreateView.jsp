<%-- 
    Document   : KeyValueDescriptionCreateView.jsp
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <c:if test="${fieldKeyType == 'input'}">
                            <input type="text" class="form-control" id="keyInput" name="keyInput" max="${fieldKeyMaxSize}" required="required" placeholder="${fieldKeyPlaceHolder}">                       
                        </c:if>                        
                        <c:if test="${fieldKeyType == 'textArea'}">
                            <textarea class="form-control" id="keyInput" name="keyInput" placeholder="${fieldKeyPlaceHolder}" rows="${fieldKeyRow}" maxlength="${fieldKeyMaxSize}"></textarea>                        
                        </c:if>
                ...
                <div class="row">
                    <div class="form-group col-md-8">
                        ...
                        <c:if test="${fieldValueType == 'input'}">
                            <input type="text" class="form-control" id="valueInput" name="valueInput" max="${fieldValueMaxSize}" required="required" placeholder="${fieldValuePlaceHolder}">                       
                        </c:if>                        
                        <c:if test="${fieldValueType == 'textArea'}">
                            <textarea class="form-control" id="valueInput" name="valueInput" placeholder="${fieldValuePlaceHolder}" rows="${fieldValueRow}" maxlength="${fieldValueMaxSize}"></textarea>                        
                        </c:if>
                        <span id="countInputValue" class="label label-warning">${fieldValueMaxSize} Restantes!</span>
                    </div>
                </div><!-- /LINHA-2 -->
                ...
                <div class="row">
                    <div class="form-group col-md-8">
                        ...
                        <c:if test="${fieldDescriptionType == 'input'}">
                            <input type="text" class="form-control" id="descriptionInput" name="descriptionInput" max="${fieldDescriptionMaxSize}" required="required" placeholder="${fieldDescriptionPlaceHolder}">                       
                        </c:if>                        
                        <c:if test="${fieldValueType == 'textArea'}">
                            <textarea class="form-control" id="descriptionInput" name="descriptionInput" placeholder="${fieldDescriptionPlaceHolder}" rows="${fieldDescriptionRow}" maxlength="${fieldDescriptionMaxSize}"></textarea>                        
                        </c:if>                        
