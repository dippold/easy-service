                    ...
                    <div class="form-group col-md-2">
                        ...
                        <SELECT id="acaoCombo" name="acaoCombo" size="1" class="form-control">
                            <c:forEach var="action" items="${actions}">
                                <option value="${action.id}" ${entity.acao == action.id ? 'selected' : ''}>${action.value}</option>
                            </c:forEach>                                                            
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <SELECT id="acaoSucessoCombo" name="acaoSucessoCombo" size="1" class="form-control">
                            <c:forEach var="action" items="${actions}">
                                <option value="${action.id}" ${entity.acaoSucesso == action.id ? 'selected' : ''}>${action.value}</option>
                            </c:forEach>   
                        </SELECT><!-- COMBOBOX ACAO-NO-MODEL -->
                    </div>                    
                    <div class="form-group col-md-2">
                        ...
                        <SELECT id="acaoFalhaCombo" name="acaoFalhaCombo" size="1" class="form-control">
                            <c:forEach var="action" items="${actions}">
                                <option value="${action.id}" ${entity.acaoFalha == action.id ? 'selected' : ''}>${action.value}</option>
                            </c:forEach> 
                        </SELECT><!-- COMBOBOX ACAO-NO-MODEL -->
                    </div>                                                             
                </div><!-- /LINHA-3 -->                
