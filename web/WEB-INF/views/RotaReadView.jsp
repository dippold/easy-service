...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div id="main" class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3>
                        ...
                        ${entity.id}
                        ${entity.sistema == 'true' ? '&nbsp;<span class="glyphicon glyphicon-hand-right" title="Model" style="color:blue"></span>&nbsp;&nbsp;<span class="glyphicon glyphicon-alert" title="Registro de Sistema!" style="color:red"></span>' : ''}
                        ${entity.mostrarNoMenu == 'true' ? '&nbsp;<span class="glyphicon glyphicon-hand-right" title="Model" style="color:blue">&nbsp;<span class="glyphicon glyphicon-pushpin" title="Aparece no Menu!" style="color:red"></span>' : ''} 
                    </h3>
                </div>
            </div><!-- LINHA-1 -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <p>&nbsp;<span class="glyphicon glyphicon-briefcase" title="Processo de Negócio" style="color:blue"></span>&nbsp;&nbsp;${entity.processoNegocio}</p>
                    <p>&nbsp;<span class="glyphicon glyphicon-th-list" title="Grupo no Menu" style="color:blue"></span>&nbsp;&nbsp;${entity.nomeGrupoMenu}</p>
