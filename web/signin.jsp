...
<html lang="pt">
    <head>
        ...
        <title>EASY SERVICES SignIn</title>
                ...
                <div id="login" class="animate form">
                    <section class="login_content">
                        <form id="frmsignin"  name="frmsignin" method="POST" action="signin">
                            <h1>Autenticação</h1>
                            <div>
                                <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="dippold.br@gmail.com" required />
                            </div>
                            <div>
                                <input type="password" class="form-control" id="passwd" name="passwd" placeholder="Senha" value="galateo2013" required />
                            </div>
                            <div>
